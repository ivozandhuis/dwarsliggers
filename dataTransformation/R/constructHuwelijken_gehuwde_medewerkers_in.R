...
hoofden <- bevolkingsregister[(bevolkingsregister$type == "hoofd") & !(is.na(bevolkingsregister$my_medewerkersnummer)) ,]
...
# write
write.table(huwelijken, "data/constructs/csv/huwelijken_gehuwde_medewerkers_in.csv", sep = ",", row.names=FALSE)
