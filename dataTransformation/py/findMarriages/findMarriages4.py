...
outfile = open('huwelijken_schoonouders_gehuwde_medewerkers_out.csv', 'w', newline='')
...
with open('huwelijken_gehuwde_medewerkers.csv', newline='') as infile:
    ...
    for row in reader:
        ...
        row['voornaam.x']      = row['voornaamVader_van_de_bruid']
        row['tussenvoegsel.x'] = row['tussenvoegselVader_van_de_bruid']
        row['achternaam.x']    = row['achternaamVader_van_de_bruid']
        row['voornaam.y']      = row['voornaamMoeder_van_de_bruid']
        row['tussenvoegsel.y'] = row['tussenvoegselMoeder_van_de_bruid']
        row['achternaam.y']    = row['achternaamMoeder_van_de_bruid']
